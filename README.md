...
│   └── code-view.js     # 课程页源码展示（语法高亮 + 行号）
├── playground/          # 「动手试试」练习场：在线改代码即时看效果
└── lessons/
    ├── 01-hello-triangle/
...
1. 每课先跑起来看效果，再往下滚动读源码（讲解全部写在代码注释里，页面已内嵌显示、带高亮和行号）
2. 打开「动手试试」练习场（首页有入口）：在线改代码——颜色、速度、顶点坐标……按 ⌘/Ctrl+Enter 运行看效果
3. 遮住代码自己重写一遍，卡住再回头看
